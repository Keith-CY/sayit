...
final class FileLogger {
    ...
    private init() {
        ...
        self.logDirectory = baseDirectory.appendingPathComponent("Logs/SayIt", isDirectory: true)
        self.logFileURL = self.logDirectory.appendingPathComponent("SayIt.log", isDirectory: false)
        self.backupLogURL = self.logDirectory.appendingPathComponent("SayIt.log.1", isDirectory: false)
