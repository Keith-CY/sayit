...
struct SayItIconFilled: View {
    ...
    var body: some View {
        ZStack {
            ...
            SayItIcon(size: self.size * 0.6, lineWidth: self.size * 0.08, color: self.color)
        }
    }
}

// Advanced variant with sophisticated negative space
struct SayItIconAdvanced: View {
    let size: CGFloat
    let color: Color
...
#Preview("SayIt Icon Variants") {
    VStack(spacing: 20) {
        Text("Standard Geometric F")
            .font(.headline)

        HStack(spacing: 20) {
            SayItIcon(size: 24, color: .white)
                .background(Color.black.opacity(0.3))

            SayItIcon(size: 32, color: .blue)

            SayItIcon(size: 48, color: .primary)
        }
        ...
        HStack(spacing: 20) {
            SayItIconAdvanced(size: 24, color: .white)
                .background(Color.black.opacity(0.3))

            SayItIconAdvanced(size: 32, color: .blue)

            SayItIconAdvanced(size: 48, color: .primary)
        }

        HStack(spacing: 20) {
            SayItIconFilled(size: 32, backgroundColor: .blue)
            SayItIconFilled(size: 40, backgroundColor: .purple)
            SayItIconFilled(size: 48, backgroundColor: Color.fluidGreen)
        }

        // Large version for app icon
        SayItIconFilled(size: 80, backgroundColor: .black, cornerRadius: 16)
    }
    .padding()
